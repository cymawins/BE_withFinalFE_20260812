//<<<REST API서버(JSON-SERVER)의 엔드 포인트>>>
export const URL={
    USERS:'http://localhost:3002/users',
    NOTICE:'http://localhost:3002/notice',
    FAQ:'http://localhost:3002/faq',
    INQUIRY:'http://localhost:3002/inquiry',
...
export const NOTICE={ALL:'all',WRITE:'write',DELETE:'delete',TOTAL:'total',CURRENT:'current'};
// TOTAL - 총 게시글수 변경 요청,CURRENT - 현재 페이지 변경 요청
export const FAQ={ALL:'all',WRITE:'write',DELETE:'delete',TOTAL:'total',CURRENT:'current'};
// TOTAL - 총 게시글수 변경 요청,CURRENT - 현재 페이지 변경 요청
